...
inline void multABt(double a11, double a12, double a13,
                    double a21, double a22, double a23,
                    double a31, double a32, double a33,
                    //
                    double b11, double b12, double b13,
                    ...
                    double &m21, double &m22, double &m23,
                    double &m31, double &m32, double &m33) {
  m11=a11*b11 + a12*b12 + a13*b13; m12=a11*b21 + a12*b22 + a13*b23; m13=a11*b31 + a12*b32 + a13*b33;
  m21=a21*b11 + a22*b12 + a23*b13; m22=a21*b21 + a22*b22 + a23*b23; m23=a21*b31 + a22*b32 + a23*b33;
  m31=a31*b11 + a32*b12 + a33*b13; m32=a31*b21 + a32*b22 + a33*b23; m33=a31*b31 + a32*b32 + a33*b33;
}

// matrix multiplication M = A * D * Transpose[B]
inline void multADBt(double a11, double a12, double a13,
                     double a21, double a22, double a23,
                     double a31, double a32, double a33,
                     //
                     ...
                     double &m21, double &m22, double &m23,
                     double &m31, double &m32, double &m33) {
  m11=a11*d11*b11 + a12*d22*b12 + a13*d33*b13; m12=a11*d11*b21 + a12*d22*b22 + a13*d33*b23; m13=a11*d11*b31 + a12*d22*b32 + a13*d33*b33;
  m21=a21*d11*b11 + a22*d22*b12 + a23*d33*b13; m22=a21*d11*b21 + a22*d22*b22 + a23*d33*b23; m23=a21*d11*b31 + a22*d22*b32 + a23*d33*b33;
  m31=a31*d11*b11 + a32*d22*b12 + a33*d33*b13; m32=a31*d11*b21 + a32*d22*b22 + a33*d33*b23; m33=a31*d11*b31 + a32*d22*b32 + a33*d33*b33;
}

// matrix determinant, determinant[A]
inline double detA(double a11, double a12, double a13,
                   double a21, double a22, double a23,
                   double a31, double a32, double a33) {
...
inline void approxGivensQuaternion(double a11, double a12, double a22, double &ch, double &sh) {
  // Given approximated givens angle, compute the corresponding rotation quaternion 
  ch = 2*(a11-a22);
  sh = a12;
  bool b = (sqrt(8)+3)*sh*sh < ch*ch;
  double w = 1.0/sqrt(ch*ch+sh*sh);
  ch=b?w*ch:cos(M_PI/8.0);
  sh=b?w*sh:sin(M_PI/8.0);
}
...
inline void jacobiConjugation(const int x, const int y, const int z,
                              ...
                              double * qV) {
  double ch,sh;
  approxGivensQuaternion(s11,s21,s22,ch,sh);
...
inline void QRGivensQuaternion(double a1, double a2, double &ch, double &sh) {
  ...
  // a2 = lower triangular entry we want to eliminate
...
inline void svd33(double A[3][3], double U[3][3], double S[3][3], double V[3][3]) { 
