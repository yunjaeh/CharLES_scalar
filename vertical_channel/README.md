...
-----
 ...
 <img src="results/V_Ra_5.4e5.gif" width="250"> <img src="results/V_Ra_2.0e6.gif" width="250"> <img src="results/V_Ra_5.0e6.gif" width="250"> 

<center>Figure. Streamwise velocity contours using different Rayleigh number, 5.4e5(left), 2.0e6(center), 5.0e6(right)</center>



 <img src="results/T_Ra_5.4e5.gif" width="250"> <img src="results/T_Ra_2.0e6.gif" width="250"> <img src="results/T_Ra_5.0e6.gif" width="250">

<center>Figure. Temperature contours using different Rayleigh number, 5.4e5(left), 2.0e6(center), 5.0e6(right)</center>
