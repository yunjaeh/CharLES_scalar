...
#ifndef CT_ONEDIMLE_H
#define CT_ONEDIMLE_H
...
//using Cantera::MultiJac;
//using Cantera::Domain1D;
using Cantera::vector_int;
//using Cantera::MultiNewton;
using Cantera::Func1;
using Cantera::vector_fp;
using Cantera::IndexError;
using Cantera::ArraySizeError;
