...
#ifndef CT_BDRY1DLE_H
#define CT_BDRY1DLE_H
...
using Cantera::InterfaceKinetics;
using Cantera::SurfPhase;
using Cantera::NotImplementedError;
...
protected:
    ...
    StFlowLe* m_flow_left, *m_flow_right;
